...
-- From:
--
-- https://www.schoolofhaskell.com/school/starting-with-haskell/basics-of-haskell/9_Evaluator
--
...
-- You can now define the evaluation by:

eval_expr xs = (evaluate (parse (tokenize xs))) 

v_ex01 = eval_expr ex01
